...
$string['configcourseconfiguration'] = 'Allows user to overwrite the current course configuration';
$string['configcoursename'] = 'Allows user to modify course fullname if enabled and overwrite course configuration is allowed';
$string['configcourseshortname'] = 'Allows user to modify course shortname if enabled and overwrite course configuration is allowed';
$string['configcoursestartdate'] = 'Allow user to modify course startdate if enabled and overwrite course configuration is allowed';
